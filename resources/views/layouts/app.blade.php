...
<head>
  ...
  <title>Sistem Informasi Manajemen Magister Teknologi Informasi UPNJATIM</title>
...
<body class="hold-transition login-page" style="background-image: url('{{ asset("img/wallup.jpg") }}'); background-size: cover; background-attachment: fixed;">
  <div class="login-box">
    <div class="login-logo">
      <img src="{{ asset('img/logowebmti.png') }}" width="100%" alt="">
    </div>
    ...
    <footer style="color: white;">
      <marquee>
          <strong>Copyright &copy; <script>document.write(new Date().getFullYear());</script> &diams; <a href="https://mti.upnjatim.ac.id/" style="color: white;">Magister Teknologi Informasi - UPN "Veteran" Jawa Timur</a>. </strong>
      </marquee>
    </footer>
  </div>
  ...
  $(document).ready(function(){
      $('#role').change(function(){
          ...
          if (kel == "Guru") {
            ...
            $("#noId").addClass("mb-3");
            $("#noId").html(`
              <input id="nomer" type="text" placeholder="No Induk Mahasiswa" class="form-control" name="nomer" autocomplete="nomer">
              <div class="input-group-append">
                <div class="input-group-text">
                  <span class="fas fa-id-card"></span>
                </div>
...
@error('id_card')
  <script>
    toastr.error("Maaf User ini tidak terdaftar sebagai Mahasiswa MTI UPN Veteran Jawa Timur!");
  </script>
@enderror
@error('guru')
  <script>
